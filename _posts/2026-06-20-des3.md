...
![Desktop View](/assets/img/2026-06-20-des3/desenc1.png){: width="100%"}
DES에서 `QWERASDF`를 `EDB`로 `KCHTBLOG`라는 키를 이용하여 암호화 한 내용이 이와 같다.


![Desktop View](/assets/img/2026-06-20-des3/playdes.png){: width="100%"}
